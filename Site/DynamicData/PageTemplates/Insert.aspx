...
<%--<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="Insert.aspx.cs" Inherits="Site.Insert" %>
            ...
            <asp:FormView runat="server" ID="FormView1" DataSourceID="DetailsDataSource" DefaultMode="Insert"
                ...
                <InsertItemTemplate>
                    <table id="detailsTable" class="DDDetailsTable" cellpadding="6">
                        ...
                        <tr class="td">
                            <td colspan="2">
                                <asp:LinkButton CssClass="btn btn-primary" runat="server" CommandName="Insert" Text="Insert" />
                                <asp:LinkButton CssClass="btn btn-default" runat="server" CommandName="Cancel" Text="Cancel" CausesValidation="false" />
                            </td>
                        </tr>
                    </table>
                </InsertItemTemplate>
