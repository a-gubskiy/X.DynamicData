...
<%--<%@ Page Language="C#" MasterPageFile="~/Site.master" CodeBehind="Edit.aspx.cs" Inherits="Site.Edit" %>
            ...
            <asp:FormView runat="server" ID="FormView1" DataSourceID="DetailsDataSource" DefaultMode="Edit"
                ...
                <EditItemTemplate>
                    <table id="detailsTable" class="DDDetailsTable" cellpadding="6">
                        ...
                        <tr class="td">
                            <td colspan="2">
                                <asp:LinkButton CssClass="btn btn-primary" runat="server" CommandName="Update" Text="Update" />
