...
<asp:Content ID="main_content" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <br />
    <br />
    <%=Resources.Global.File %>: <asp:FileUpload ID="file_upload" runat="server" />
    <br />
    <asp:Button CssClass="btn btn-primary" runat="server" ID="do_upload" Text="<%$Resources:Global, UploadFile  %>" OnClick="do_upload_Click"/>
    <br /><br />
    <div id="result" runat="server" clientidmode="Static" Visible="False">
        <div class="input-group">
            <span class="input-group-addon">Ссылка на файл</span>
